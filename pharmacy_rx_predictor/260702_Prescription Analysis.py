"""
260702_Prescription Analysis — 処方箋獲得予測ツール（確定版）

住所（＝出店候補地）と商圏半径を入力すると、圏内の医療機関・薬局を収集し、
その地点に薬局を出した場合に獲得できる年間処方箋枚数を予測する。
...
st.set_page_config(
    page_title="Prescription Analysis（処方箋獲得予測）",
    page_icon="🎯",
    layout="wide",
)
...
# ─── UI ───────────────────────────────────────────────────────────────────────
st.title("🎯 Prescription Analysis — 処方箋獲得予測")
st.caption("Version 260702")
st.caption(
